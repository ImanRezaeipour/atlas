...
namespace GTS.Clock.Model
{
    public class PersonTASpec : IEntity
    {
        ...
        public virtual decimal OldUserInterfaceRuleGroupID { get; set; }

        public virtual Boolean IsLeaveYearDependonContract { get; set; }

        public virtual int LeaveYearMonth { get; set; }

        public virtual int LeaveYearDay { get; set; }

        /// <summary>
        /// پرسنل اضافه کاری می باشد یا خیر
        /// </summary>
        public virtual Boolean HasPeyment { get; set; }
        /// <summary>
        /// پرسنل شب کاری می باشد یا خیر
        /// </summary>
        public virtual Boolean NightWork { get; set; }
        /// <summary>
        /// پرسنل تعطیلی کاری می باشد یا خیر
        /// </summary>
        public virtual Boolean HolidayWork { get; set; }

        /// <summary>
        /// پرسنل دارای مجوز اضافه کار میباشد یا نه
        /// </summary>
        public virtual Boolean OverTimeWork { get; set; }
