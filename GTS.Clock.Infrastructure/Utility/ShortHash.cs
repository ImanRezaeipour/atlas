...
namespace GTS.Clock.Infrastructure.Utility
{
    ...
    {
        public const string DEFAULT_ALPHABET = "ABCDEFGHIJKLMNPQRSTUVWXYZ123456789";
        ...
        public ShortHash(string salt = "GhadirGTS", int minHashLength = 5, string alphabet = DEFAULT_ALPHABET)
        {
