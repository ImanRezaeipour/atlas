define(["module"], function(e) {
    ...
    return n = {
        ...
        load: function(e, t, r, o) {
            ...
            var i = n.parseName(e)
              ...
              , s = t.toUrl(a)
              , u = v.useXhr || n.useXhr;
            return 0 === s.indexOf("empty:") ? void r() : void (!l || u(s, c, f, p) ? n.get(s, function(t) {
    ...
    n.get = function(e, n, r) {
        ...
        a.onreadystatechange = function(n) {
            ...
            o > 399 && 600 > o ? (i = new Error(e + " HTTP status: " + o),
            i.xhr = a,
            r && r(i)) : t(a.responseText),
