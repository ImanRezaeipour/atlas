        ...
        var validators = {
            MaxOverTime: {
                validators: {
                    ...
                    //remote: { type: "GET", url: '/DesktopModules/Atlas/api/overtimeperson/validateOverTime', delay: 2000, message: 'مقدار سرانه اضافه کاری تشویقی مجاز نمی باشد' }
                }
            },
            MaxNightWork: {
                validators: {
                    ...
                    //,remote: { url: '/DesktopModules/Atlas/api/overtimeperson/validateNightWork', delay: 2000, message: 'مقدار سرانه شب کاری تشویقی مجاز نمی باشد' }
                }
            },
            MaxHolidayWork: {
                validators: {
                    ...
                    //remote: { url: '/DesktopModules/Atlas/api/overtimeperson/validateHolidayWork', delay: 2000, message: 'مقدار سرانه تعطیل کاری تشویقی مجاز نمی باشد' }
                }
            }
        };
