...
void Page_Load(Object sender,EventArgs e)
{
  ...
  try
  {
      ...
      if (SessionHelper.HasSessionValue(SessionHelper.AllDepartments))
          departmentList = (IList<Department>)SessionHelper.GetSessionValue(SessionHelper.AllDepartments);
      else
      {
          departmentList = departmentBusiness.GetAll();
          SessionHelper.SaveSessionValue(SessionHelper.AllDepartments, departmentList); 
      }
      IList<Department> deparmentsList = departmentBusiness.GetDepartmentChilds(departmentID, departmentList);
      ...
      IList<GTS.Clock.Model.Person> personnelList = managerBusiness.GetDepartmentPerson(departmentID);
      foreach (GTS.Clock.Model.Person childPerson in personnelList)
      {
