define(['ko',
        'spa.engine.infrastructure.htmlLoader!/overtimeEdari/edit',
        './validator',
...
function (ko, template, validator, dataService) {
    function viewModel(params) {
        ...
        function getData() {
            dataService.get('/api/overtimeedari/getitem/', self.id).done(function (data) {
        ...
        function registerValidator() {
            self.success = function () {
                ...
                dataService.put('/api/overtimeedari/edit/', self.id, toJS())
                    .done(function (data) {
                        params.context.visible(false);
