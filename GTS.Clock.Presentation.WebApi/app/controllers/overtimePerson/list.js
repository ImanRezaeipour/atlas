define(['jquery',
        'ko',
        'spa.engine.infrastructure.htmlLoader!/overtimePerson/list',
...
function ($, ko, template, dataTable, moment, datepicker, dataService, message, select, modal) {
    function viewModel(params) {
        ...
        //define DataTable
        self.dtURL = '/api/overtimeperson/list';
        self.dtColumns = [
            {
                targets: 0,
                searchable: false,
        ...
        self.overtimeTotalPersonDataTable = new dataTable(self.dtTotalColumns, 1, self.dtFilter, self.dtTotalDraw, self.dtTotalPage, self.dtTotalSelect, '/api/overtimeperson/listTotal');
        ...
        self.edit = function () {
            ...
            self.modal.body({ name: 'spa-app-overtimePersonEdit', params: { id: self.selectedId() } });
            self.modal.visible(true);
        };
